/*global history */
sap.ui.define([
		"com/prod/controller/BaseController",
		...
		"sap/ui/Device",
		"com/prod/model/formatter",
		"com/prod/model/grouper",
		...
		return BaseController.extend("com.prod.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.prod.view.ViewSettingsDialog", this);
