sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/prod/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.prod.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/prod/localService/mockserver"], function (mockserver) {
